...
type Input struct {
	...
	*InputEmbeddedPtr
	...
	ValueSeven bool              `cliutil:"option=value-seven func=boolstring"`
}
...
func TestReadOptions(t *testing.T) {
	...
	ex7 := true
	if actual := input.ValueSeven; actual != ex7 {
		t.Errorf("got %t, expected %t", actual, ex7)
	}
}
